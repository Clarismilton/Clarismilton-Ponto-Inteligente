...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		LancamentoEntity lancamento = obterDadosLancamento();
		BDDMockito.given(this.funcionarioService.buscarPorId(Mockito.anyLong())).willReturn(Optional.of(new FuncionarioEntity()));
		BDDMockito.given(this.lancamentoService.persistir(Mockito.any(LancamentoEntity.class))).willReturn(lancamento);
	...
	public void testRemoverLancamento() throws Exception {
		BDDMockito.given(this.lancamentoService.buscarPorId(Mockito.anyLong())).willReturn(Optional.of(new LancamentoEntity()));
	...
	private LancamentoEntity obterDadosLancamento() {
