...
import br.com.clarismilton.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
		...
		Optional<FuncionarioEntity> funcionario = this.funcionarioService.buscarPorId(id);
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	private void atualizarDadosFuncionario(FuncionarioEntity funcionario, FuncionarioDto funcionarioDto, BindingResult result)
			throws NoSuchAlgorithmException {
	 ...
	 */
	private FuncionarioDto converterFuncionarioDto(FuncionarioEntity funcionario) {
