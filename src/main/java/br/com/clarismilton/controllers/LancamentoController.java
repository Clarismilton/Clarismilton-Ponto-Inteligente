...
import br.com.clarismilton.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		Page<LancamentoEntity> lancamentos = this.lancamentoService.buscarPorFuncionarioId(funcionarioId, pageRequest);
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
		...
		Optional<LancamentoEntity> lancamento = this.lancamentoService.buscarPorId(id);
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		LancamentoEntity lancamento = this.converterDtoParaLancamento(lancamentoDto, result);
	...
	private void validarFuncionario(LancamentoDto lancamentoDto, BindingResult result) {
		...
		Optional<FuncionarioEntity> funcionario = this.funcionarioService.buscarPorId(lancamentoDto.getFuncionarioId());
	 ...
	 */
	private LancamentoDto converterLancamentoDto(LancamentoEntity lancamento) {
	 ...
	 * @throws ParseException 
	 */
	private LancamentoEntity converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result) throws ParseException {
		LancamentoEntity lancamento = new LancamentoEntity();

		if (lancamentoDto.getId().isPresent()) {
			Optional<LancamentoEntity> lanc = this.lancamentoService.buscarPorId(lancamentoDto.getId().get());
			if (lanc.isPresent()) {
				lancamento = lanc.get();
			} else {
			...
			lancamento.setFuncionario(new FuncionarioEntity());
